<%@ Page Title="" Language="C#" MasterPageFile="~/customer/Site1.Master" AutoEventWireup="true" CodeBehind="queryresult.aspx.cs" Inherits="smartadtube.com.customer.queryresult" %>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="lbl_taskdataid" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 99px">
