<%@ Page Title="" Language="C#" MasterPageFile="Site1.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="smartadtube.com.customer.AdminPanel" %>
                                ...
                                <div class="m-widget24">
                                    <div class="m-widget24__item">
                                        ...
                                        <span class="m-widget24__stats m--font-brand">
                                            <asp:Label ID="lbl_totaltask" runat="server"></asp:Label>
                                        </span>
                            ...
                            <div class="m-widget24">
                                <div class="m-widget24__item">
                                    ...
                                    <span class="m-widget24__stats m--font-danger">₹
                                        <asp:Label ID="lbl_tbalance" runat="server"></asp:Label>*</span>
                                    <div class="m--space-10"></div>
                                    <div class="progress m-progress--sm">
