<%@ Page Title="" Language="C#" MasterPageFile="~/customer/Site1.Master" AutoEventWireup="true" CodeBehind="resumetaskedit.aspx.cs" Inherits="smartadtube.com.customer.resumetaskedit" %>
                            ...
                            <div class="m-form m-form--fit m-form--label-align-right" runat="server">
                                <div class="m-portlet__body" style="padding-top: 5px;">
                                    <div class="form-group m-form__group" style="max-height: 670px; overflow: auto">
                                        ...
                                        <asp:TextBox ID="txt_firstname" runat="server" CssClass="form-control m-input m-input--air" placeholder="Enter First Name" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_middlename" runat="server" CssClass="form-control m-input m-input--air" placeholder="Enter Middle Name" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_lastname" runat="server" CssClass="form-control m-input m-input--air" placeholder="Enter Last Name" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_dob" runat="server" CssClass="form-control m-input m-input--air" placeholder="Date of Birth" autocomplete="off"></asp:TextBox>
                                        <label>Gender</label>
                                        ...
                                        <asp:TextBox ID="txt_gender" runat="server" CssClass="form-control m-input m-input--air" placeholder="Gender" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_nationality" runat="server" CssClass="form-control m-input m-input--air" placeholder="Nationality" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_maritalstatus" runat="server" CssClass="form-control m-input m-input--air" placeholder="Marital Status" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_passport" runat="server" CssClass="form-control m-input m-input--air" placeholder="Passport" autocomplete="off"></asp:TextBox>
                                        <label>Hobbies </label>
                                        ...
                                        <asp:TextBox ID="txt_hobbies" runat="server" CssClass="form-control m-input m-input--air" placeholder="Hobbies" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_languageknown" runat="server" CssClass="form-control m-input m-input--air" placeholder="Language Known" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_address" runat="server" CssClass="form-control m-input m-input--air" placeholder="Address" TextMode="MultiLine" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_landmark" runat="server" CssClass="form-control m-input m-input--air" placeholder="Land Mark" autocomplete="off"></asp:TextBox>
                                        <label>City </label>
                                        ...
                                        <asp:TextBox ID="txt_city" runat="server" CssClass="form-control m-input m-input--air" placeholder="City" autocomplete="off"></asp:TextBox>
                                        <label>State</label>
                                        ...
                                        <asp:TextBox ID="txt_state" runat="server" CssClass="form-control m-input m-input--air" placeholder="State" autocomplete="off"></asp:TextBox>
                                        <label>Pincode </label>
                                        ...
                                        <asp:TextBox ID="txt_pincode" runat="server" CssClass="form-control m-input m-input--air" placeholder="Pincode" autocomplete="off"></asp:TextBox>
                                        <label>Mobile   </label>
                                        ...
                                        <asp:TextBox ID="txt_mobile" runat="server" CssClass="form-control m-input m-input--air" placeholder="Mobile" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_emailid" runat="server" CssClass="form-control m-input m-input--air" placeholder="Email ID" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_sscresult" runat="server" CssClass="form-control m-input m-input--air" placeholder="SSC Result" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_sscuniversity" runat="server" CssClass="form-control m-input m-input--air" placeholder="SSC Board/University" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_sscyear" runat="server" CssClass="form-control m-input m-input--air" placeholder="SSC Passing Year" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_hscresult" runat="server" CssClass="form-control m-input m-input--air" placeholder="HSC Result" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_hscuniversity" runat="server" CssClass="form-control m-input m-input--air" placeholder="HSC Board/University" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_hscyear" runat="server" CssClass="form-control m-input m-input--air" placeholder="HSC Passing Year" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_diplomadegree" runat="server" CssClass="form-control m-input m-input--air" placeholder="Diploma Degree" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_diplomaresult" runat="server" CssClass="form-control m-input m-input--air" placeholder="Diploma Result" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_diplomauniversity" runat="server" CssClass="form-control m-input m-input--air" placeholder="Diploma University" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_diplomayear" runat="server" CssClass="form-control m-input m-input--air" placeholder="Diploma Year" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_graduationdegree" runat="server" CssClass="form-control m-input m-input--air" placeholder="Graduation Degree" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_graduationresult" runat="server" CssClass="form-control m-input m-input--air" placeholder="Graduation Result" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_graduationuniversity" runat="server" CssClass="form-control m-input m-input--air" placeholder="Graduation University" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_graduationyear" runat="server" CssClass="form-control m-input m-input--air" placeholder="Graduation Year" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_postgraduationdegree" runat="server" CssClass="form-control m-input m-input--air" placeholder="Post Graduation Degree" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_postgraduationresult" runat="server" CssClass="form-control m-input m-input--air" placeholder="Post Graduation Result" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_postgraduationuniversity" runat="server" CssClass="form-control m-input m-input--air" placeholder="Post Graduation University" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_postgraduationyear" runat="server" CssClass="form-control m-input m-input--air" placeholder="Post Graduation Year" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_highestleveleducation" runat="server" CssClass="form-control m-input m-input--air" placeholder="Highest Level Education" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_totalworkyear" runat="server" CssClass="form-control m-input m-input--air" placeholder="Year" autocomplete="off"></asp:TextBox>
                                        <label>Month</label>
                                        ...
                                        <asp:TextBox ID="txt_totalworkmonth" runat="server" CssClass="form-control m-input m-input--air" placeholder="Month" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_totalcompanieswork" runat="server" CssClass="form-control m-input m-input--air" placeholder="Total Companies Worked For" autocomplete="off"></asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txt_lastcurrentemploye" runat="server" CssClass="form-control m-input m-input--air" placeholder="Last/Current Employer" autocomplete="off"></asp:TextBox>
                                        <br />
