<%@ Page Title="" Language="C#" MasterPageFile="Site1.Master" AutoEventWireup="true" CodeBehind="Paymentrequest.aspx.cs" Inherits="smartadtube.com.demo.Paymentrequest" %>
                              ...
                              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" CssClass="table table-bordered m-table m-table--border-brand m-table--head-bg-brand" >
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Status" SortExpression="status">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" style="color:green;" Text='<%# Bind("status") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                        ...
                        <div class="m-widget24">
                            <div class="m-widget24__item">
                                ...
                                <span class="m-widget24__stats m--font-brand">₹
                                    <asp:Label ID="lbl_totalpayment" runat="server" Text="6798"></asp:Label>
                                </span>
