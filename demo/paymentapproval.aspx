<%@ Page Title="" Language="C#" MasterPageFile="Site1.Master" AutoEventWireup="true" CodeBehind="paymentapproval.aspx.cs" Inherits="smartadtube.com.demo.paymentapproval" %>
                              ...
                              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" CssClass="table table-bordered m-table m-table--border-brand m-table--head-bg-brand" >
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Status" SortExpression="status">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("approval") %>' style="color:green;"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
